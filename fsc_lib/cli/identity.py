...
from fibostack import exceptions
from fibostack.identity.v3 import project
...
def find_project(sdk_connection, name_or_id, domain_name_or_id=None):
    ...
    fibostack.identity.v3.Project resource.

    :param sdk_connection: Connection object of FiboStack SDK.
    :type sdk_connection: `fibostack.connection.Connection`
    ...
    :rtype: `fibostack.identity.v3.project.Project`
    ...
    # NOTE: FiboStack SDK raises HttpException for 403 response code.
