...
class TestShellArgV(utils.TestShell):
    ...
    def test_shell_argv(self):
        ...
        with mock.patch(
            "fsc_lib.shell.FiboStackShell.run",
            self.app,
        ):
...
class TestShellOptions(utils.TestShell):
    """Test the option handling by argparse and fibostack.config.loader
...
class TestShellCli(utils.TestShell):
    ...
    def test_shell_args_no_options(self):
        ...
        with mock.patch(
            "fsc_lib.shell.FiboStackShell.initialize_app",
            self.app,
        ):
    ...
    def test_shell_args_cloud_no_vendor(self, config_mock):
        ...
        # fsc_lib.shell.DEFAULT_INTERFACE is public.
        self.assertEqual(
            DEFAULT_AUTH_URL,
