...
from fibostack.config import cloud_config
from fibostack.config import defaults
from fibostack import connection
...
from fsc_lib.tests import utils
...
class TestClientManager(utils.TestClientManager):
    ...
    @mock.patch('fsc_lib.api.auth.check_valid_authentication_options')
