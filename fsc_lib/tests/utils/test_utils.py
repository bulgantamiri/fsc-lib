...
from fsc_lib.tests import fakes
from fsc_lib.tests import utils as test_utils
...
class TestSDKUtils(test_utils.TestCase):
    ...
    def _test_get_fsc_show_columns_for_sdk_resource(
        self,
        sdk_resource,
        column_map,
        ...
        (
            display_columns,
            attr_columns,
        ) = utils.get_fsc_show_columns_for_sdk_resource(
    ...
    def test_get_fsc_show_columns_for_sdk_resource_empty(self):
        self._test_get_fsc_show_columns_for_sdk_resource(
            {}, {}, tuple(), tuple()
        )

    def test_get_fsc_show_columns_for_sdk_resource_empty_map(self):
        self._test_get_fsc_show_columns_for_sdk_resource(
            {'foo': 'foo1'}, {}, ('foo',), ('foo',)
        )

    def test_get_fsc_show_columns_for_sdk_resource_empty_data(self):
        self._test_get_fsc_show_columns_for_sdk_resource(
            {}, {'foo': 'foo_map'}, ('foo_map',), ('foo_map',)
        )

    def test_get_fsc_show_columns_for_sdk_resource_map(self):
        self._test_get_fsc_show_columns_for_sdk_resource(
            {'foo': 'foo1'}, {'foo': 'foo_map'}, ('foo_map',), ('foo',)
        )

    def test_get_fsc_show_columns_for_sdk_resource_map_dup(self):
        self._test_get_fsc_show_columns_for_sdk_resource(
    ...
    def test_get_fsc_show_columns_for_sdk_resource_map_full(self):
        self._test_get_fsc_show_columns_for_sdk_resource(
            {'foo': 'foo1', 'bar': 'bar1'},
            {'foo': 'foo_map', 'new': 'bar'},
            ('bar', 'foo_map'),
